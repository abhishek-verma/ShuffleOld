...
public class MusicServiceUnused extends Service implements
    ...
    private static final String TAG = LogHelper.makeLogTag(MusicServiceUnused.class);
    ...
    public void onCreate() {
        ...
        mSession = new MediaSessionCompat(this, "MusicServiceUnused");
...
//        startService(new Intent(getApplicationContext(), MusicServiceUnused.class));
    }
    ...
    private static class DelayedStopHandler extends Handler {
        private final WeakReference<MusicServiceUnused> mWeakReference;

        private DelayedStopHandler(MusicServiceUnused service) {
            mWeakReference = new WeakReference<>(service);
        }

        @Override
        public void handleMessage(Message msg) {
            MusicServiceUnused service = mWeakReference.get();
